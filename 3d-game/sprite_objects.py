...
class Sprites:
    def __init__(self):
        ...
        self.sprite_types = {
            ...
            'pedestal': pygame.image.load(f'sprites/pedestal/0.png').convert_alpha(),
            'devil': [pygame.image.load(f'sprites/devil/{i}.png').convert_alpha() for i in range(8)],
            'shot': pygame.image.load(f'sprites/shot/0.png').convert_alpha(),
        }
        self.list_of_objects = [
            SpriteObject(self.sprite_types['shot'], True, (xx,yy), -0.3, 0.3),

            SpriteObject(self.sprite_types['barrel'], True, (12.43, 9.58), 1.8, 0.4),
            SpriteObject(self.sprite_types['barrel'], True, (9.22, 5.41), 1.8, 0.4),
            SpriteObject(self.sprite_types['barrel'], True, (1.71, 1.62), 1.8, 0.4),
            SpriteObject(self.sprite_types['barrel'], True, (3.50, 11.65), 1.8, 0.4),
